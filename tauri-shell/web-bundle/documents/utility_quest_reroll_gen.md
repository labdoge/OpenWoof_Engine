...
- Do not repeat the same title, request, objective, completion conditions, or the same theme + scenario relationship setup.
- Keep the same NPC, bottleneck gate, scenario premise, and relationship pressure, but explore different emotional angles and concrete player actions.
