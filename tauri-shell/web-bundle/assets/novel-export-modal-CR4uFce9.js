const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./modules-CEW99snh.js","./vendor-DICsj_8Q.js"])))=>i.map(i=>d[i]);
import{dy as O,e as o,_ as S,d as x}from"./modules-CEW99snh.js";import{ay as I,x as k,g as G,e as c,c as C,a5 as D,aL as Y,B as A,a as X}from"./workshop-C511Hn2L.js";import{X as w,p as F}from"./agents-CmnuPw5W.js";import"./vendor-DICsj_8Q.js";const R={literary:"文學小說風格——優美的散文、豐富的內心描寫、意象化的場景刻畫。避免直白的情節推進，注重氛圍營造與角色心理描繪。",light_novel:"輕小說風格——流暢明快的敘事節奏、活潑的對話、適度的場景描寫。使用輕鬆的語氣，保留角色的可愛特質。",web_novel:"網路小說風格——緊湊的情節推進、直接的敘事、短段落。以劇情衝突和角色互動為主，節奏快速。",screenplay:"劇本風格——以對話和動作描述為主，極簡的場景敘述。使用分鏡式的場景切換。"},$={short:{minChars:2e3,maxChars:4e3,label:"短篇（~2000字）"},medium:{minChars:5e3,maxChars:8e3,label:"中篇（~5000字）"},long:{minChars:1e4,maxChars:15e3,label:"長篇（~10000字）"}},H=`You are a fiction editor creating a chapter outline from gameplay session transcript.
